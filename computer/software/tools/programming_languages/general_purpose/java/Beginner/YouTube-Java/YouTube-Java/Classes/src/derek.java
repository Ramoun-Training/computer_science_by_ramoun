...
public class derek {
...

	{
...

		{
			...
			userInput.next(); // Skips the last user input and waits for the
								// next
	...
	/*
	 * If you prefer to throw an exception to the calling method you use throws
	 * 
...

	{
		...
		// If used finally is always executed whether there was an exception or
		// not

		// It is used for clean up work like closing files and database
		// connections
